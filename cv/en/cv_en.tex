...
\cventry{04/15--09/16}{Voluntary}{Student newspaper a\address{Liegnitzer Str. 41}{10999 Berlin}{Deutschland \medskip}
\phone[mobile]{+49~(0)~176~8156~8162}
d rem}{Dresden}{Journalist}{
...
\cvline{Office applications: }{openOffice/LibreOffice/Office, PowerPoint, \LaTeX}

\cvline{Programming languages: }{C\#, Java, C++, C}
\cvline{Scripting languages: }{Python, R, Ruby, bash scripting}

\cvline{Database languages: }{SQL Server, MariaDB, PostreSQL, MongoDB}
\cvline{Game engines: }{Unity, MonoGame}

\cvline{Web languages: }{HTML, CSS, JavaScript/jQuery, PHP}
...
\cvline{Image-processing: }{Basic knowledge (Gimp, Inkscape)}
